#
#  Be sure to run `pod spec lint GYSide.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "gaoyuan"
  # s.authors            = { "gaoyuan" => "2502905737@qq.com" }
  ...
  s.source       = { :git => "https://github.com/yuan-gao/GYSide.git", :tag => "#{s.version}" }
